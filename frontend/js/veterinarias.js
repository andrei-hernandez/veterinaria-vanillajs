...
const documento = document.getElementById("id");
const apellido = document.getElementById("apellido");
const indice = document.getElementById("indice");
const form = document.getElementById("form");
const btnGuardar = document.getElementById("btn-guardar");
const listaVeterinarias = document.getElementById("lista-veterinarias");
const url = "https://veterinaria-vanillajs-backend.vercel.app/veterinaries";
let veterinarias = [];
...
async function listarVeterinarias() {
  try {
    ...
    <td colspan="5" class="lista-vacia" class="lista-vacia">No hay veterinarias</td>
  </tr>`;
  } catch (error) {
    console.log({ error });
    $(".alert").show();
...
function editar(index) {
  return function cuandoCliqueo() {
    ...
    documento.value = veterinaria.id;
  };
}
